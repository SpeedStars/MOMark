...
public class mngTransInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbref = FirebaseDatabase.getInstance().getReference(key).child("Transaksi").child(key1).child(key2);
        ...
        FirebaseRecyclerOptions<Order2> options = new FirebaseRecyclerOptions.Builder<Order2>().setQuery(dbref2.child("Transaksi").child(key1).child(key2).child("Menu"),Order2.class).build();
